...
HD_PWD='C:/Users/Frank Andes/Documents/VScode_VHDL/DSD2-MipsProcessor/ProjectFile/ProjectFile.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mips_wrapper.tcl -notrace
