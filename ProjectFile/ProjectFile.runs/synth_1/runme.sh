...
HD_PWD='C:/Users/Frank Andes/Documents/VScode_VHDL/DSD2-MipsProcessor/ProjectFile/ProjectFile.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_wrapper.tcl
